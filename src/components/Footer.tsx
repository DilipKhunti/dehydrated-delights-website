    ...
    <footer className="bg-sage-900 text-white pt-16 pb-8">
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">Hare Krishna Food</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/certifications" className="text-gray-300 hover:text-white transition-colors">
                  Certifications
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products#herbs" className="text-gray-300 hover:text-white transition-colors">
                  Dehydrated Herbs
                </Link>
              </li>
              <li>
                <Link to="/products#custom" className="text-gray-300 hover:text-white transition-colors">
                  Custom Solutions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@harekrishnafood.com" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Hare Krishna Food. All rights reserved.
          </p>
