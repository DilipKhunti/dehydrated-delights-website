      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/certifications" className="text-gray-300 hover:text-accent transition-colors">
                  Certifications
                </Link>
              </li>
              <li>
                <Link to="/industries" className="text-gray-300 hover:text-accent transition-colors">
                  Industries We Serve
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <Link to="/sitemap" className="text-gray-400 hover:text-accent text-sm">
              Sitemap
            </Link>
          </div>
        </div>
